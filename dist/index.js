...
var Comment_1 = __importDefault(require("./Router/Comment"));
var Login_1 = __importDefault(require("./Router/Login"));
var Registration_1 = __importDefault(require("./Router/Registration"));
var SinglePost_1 = __importDefault(require("./Router/SinglePost"));
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, mongoose_1.default.connect("".concat(MongoDB))];
                case 1:
                    _a.sent();
